...
* 아래 서비스로 서비스 게이트웨이를 생성하면 인터넷을 경유하지 않고, NHN Cloud 내부 네트워크로 접근할 수 있습니다.
    ...
    * 아래 기재되지 않은 서비스는 [고객 센터](https://www.ninc.go.kr/kr/support/inquiry)로 문의하세요.
...
| --- | ------------------ | -------- |
| IaaS API Identity | IaaS API Identity | https://api-identity-infrastructure.ngovc.com |
| [NHN Container Registry(NCR)](/Container/NCR/ko/overview-ngsc) | NHN Container Registry(NCR) | 사용자 레지스트리 URI |
| [Object Storage](/Storage/Object%20Storage/ko/api-guide-ngovc/) | Object Storage | https://{region code}-api-object-storage.ngovc.com |